...
class FPDF
{
	...
	function FPDF($orientation='P', $unit='mm', $format='A4')
	{
		...
		'letter'=>array(612,792), 'legal'=>array(612,1008), 'form12'=>array(575.44, 864.57), 'etiqueta'=>array(226.733, 141.733), 'factura'=>array(566.933, 575.4373));
		//21.0 x 29.7 hoja a$
                //28.346666
                if(is_string($format))
	...
	function WriteHTML($html, $alineacion = "j")
	{
		//Intérprete de HTML
		$html=str_replace("\n",' ',$html);
