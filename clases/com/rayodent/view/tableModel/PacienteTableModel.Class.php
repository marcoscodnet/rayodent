...
class PacienteTableModel extends ListarTableModel {
    ...
    private function initColumns() {
        ...
        $this->columnNames[] = RYT_PACIENTE_CD_MEDIO;
        $this->columnWidths[] = 80;
    }
    ...
    public function getValue($anObject, $columnIndex) {
        ...
        switch ($columnIndex) {
            ...
            case 6:
                if($oPaciente->getDs_otroMedio()){
                    $value = $oPaciente->getMedio()->getDs_medio().' - '.$oPaciente->getDs_otroMedio();
                }
                else{
                    $value = $oPaciente->getMedio()->getDs_medio();
                }
    ...
    public function getEncabezados() {
        ...
        $encabezados[] = $this->buildTh($this->getColumnName(6), 'cd_medio', 'cd_medio');
