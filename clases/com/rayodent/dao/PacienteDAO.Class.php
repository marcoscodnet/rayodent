...
class PacienteDAO {
    ...
    public static function insertarPaciente(Paciente $oPaciente) {
        ...
        $cd_medio = $oPaciente->getCd_medio();
        $ds_otroMedio = $oPaciente->getDs_otroMedio();

        $sql = "INSERT INTO paciente (ds_apynom, cd_tipodoc, nu_doc, ds_direccion, ds_telefono, ds_email, dt_nacimiento, cd_medio, ds_otroMedio) VALUES('$ds_apynom', '$cd_tipodoc', '$nu_doc', '$ds_direccion', '$ds_telefono', '$ds_email', $dt_nacimiento, '$cd_medio', '$ds_otroMedio')";
    ...
    public static function modificarPaciente(Paciente $oPaciente) {
        ...
        $sql = "UPDATE paciente SET ds_apynom = '$ds_apynom', cd_tipodoc = '$cd_tipodoc', nu_doc = '$nu_doc', ds_direccion = '$ds_direccion', ds_telefono = '$ds_telefono', ds_email = '$ds_email', dt_nacimiento = $dt_nacimiento, cd_medio = '$cd_medio', ds_otroMedio = '$ds_otroMedio' WHERE cd_paciente = $cd_paciente ";
    ...
    public static function getPacientes(CriterioBusqueda $criterio) {
        ...
        $sql .= " LEFT JOIN medio M ON (P.cd_medio = M. cd_medio)";
