 ...
 * 
 */
abstract class EditarVigenciasypreciosInitAction extends EditarInitAction {
    ...
    protected function getXTemplate() {
        return new XTemplate(RYT_TEMPLATE_EDITAR_VIGENCIASYPRECIOS);
    }
    ...
    protected function getEntidad() {
        ...
        $oPracticaobrasocial->setNu_limiterepeticiones(FormatUtils::getParamPOST('nu_limiterepeticiones'));
    ...
    protected function parseEntidad($entidad, XTemplate $xtpl) {
        ...
        $xtpl->assign('cd_practica_selected', stripslashes($oPracticaobrasocial->getCd_practica()));
        $xtpl->assign('cd_obrasocial_selected', stripslashes($oPracticaobrasocial->getCd_obrasocial()));
