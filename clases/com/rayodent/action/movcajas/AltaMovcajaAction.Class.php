...
/**
 * Acci�n para dar de alta un movcaja.
 * 
 * @author modelBuilder
 * @since 14-12-2011
 * 
 */
class AltaMovcajaAction extends EditarMovcajaAction {
    ...
    protected function editar($oEntidad) {
        ...
        if (!$this->isAjax()) {
            ...
            $manager->agregarMovcaja($oEntidad);
        } else {
    ...
    function camposObligatoriosCompletos($oEntidad) {
        ...
        //Si es pr�ctica, es obligatorio: medico, paciente, personal, tipoconcepto, concepto, practica, importe
        ...
        $oPracticaObrasocialManager = new PracticaobrasocialManager();
        $oPracticasObrasociales = $oPracticaObrasocialManager->getPracticaobrasociales($oNewCriterio);
